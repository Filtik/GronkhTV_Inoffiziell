...
//import de.filtik.gronkhtv.CardPresenter
//import de.filtik.gronkhtv.DetailsActivity
//import de.filtik.gronkhtv.DetailsDescriptionPresenter
//import de.filtik.gronkhtv.MainActivity
...
//        Log.d(TAG, "DetailsFragment doInBackground: " + mSelectedMovie?.toString())
...
//        Glide.with(activity!!)
//            .load(mSelectedMovie?.preview_url)
//            .centerCrop()
//            .error(R.drawable.default_background)
...
//        Log.d(TAG, "DetailsFragment setupDetailsOverviewRowPresenter")
...
//        Log.d(TAG, "DetailsFragment setupRelatedMovieListRow")
//        val subcategories = arrayOf(getString(R.string.related_movies))
//        val list = MovieManager.setupMovies(requireContext()).start
//
