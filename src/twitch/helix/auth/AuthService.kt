package de.filtik.gronkhtv.twitch.helix.auth

import de.filtik.gronkhtv.twitch.helix.auth.model.request.OauthAppTokenRequestModel
import de.filtik.gronkhtv.twitch.helix.auth.model.request.OauthRevokeRequestModel
import de.filtik.gronkhtv.twitch.helix.auth.model.request.OauthUserTokenRequestModel
import de.filtik.gronkhtv.twitch.helix.auth.model.response.AppToken
import de.filtik.gronkhtv.twitch.helix.auth.model.response.UserToken
import de.filtik.gronkhtv.twitch.helix.http.extensions.headersOfSerializableObject
import de.filtik.gronkhtv.twitch.helix.http.extensions.parametersOfSerializableObject
